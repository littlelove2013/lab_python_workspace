...
class vgg16:
    ...
    def convlayers(self):
        ...
        with tf.name_scope('conv1_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 3, 64], dtype=tf.float32,trainable=False,
        ...
        with tf.name_scope('conv1_2') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 64, 64], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv2_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 64, 128], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv2_2') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 128, 128], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv3_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 128, 256], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv3_2') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 256, 256], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv4_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 256, 512], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
        ...
        with tf.name_scope('conv4_2') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 512, 512], dtype=tf.float32,trainable=False,
                                                     stddev=1e-1), name='weights')
    ...
    def fc_layers(self):
        ...
        with tf.name_scope('fc1') as scope:
            ...
            fc1w = tf.Variable(tf.truncated_normal([shape, 4096],trainable=False,
                                                         dtype=tf.float32,
                                                         stddev=1e-1), name='weights')
        ...
        with tf.name_scope('fc2') as scope:
            fc2w = tf.Variable(tf.truncated_normal([4096, 4096],trainable=False,
                                                         dtype=tf.float32,
                                                         stddev=1e-1), name='weights')
        ...
        with tf.name_scope('fc3') as scope:
            fc3w = tf.Variable(tf.truncated_normal([4096, 1000],trainable=False,
                                                         dtype=tf.float32,
                                                         stddev=1e-1), name='weights')
